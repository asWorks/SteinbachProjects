...
{
    public class SI_BelegeCollection : ObservableCollection<SI_Belege>
    {
        ...
        public SI_BelegeCollection(IEnumerable<SI_Belege> Artikeltable, SteinbachEntities context)
            :base(Artikeltable)
        {
            try
            {
